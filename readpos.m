function [imglist]=readpos(rootpath)
if nargin<1
...
for i=1:filenum
    ...
    if strcmp(filelist(i).name,'.')|| strcmp(filelist(i).name,'..')||strcmp(filelist(i).name,'Thumbs.db')
        ...
        posvector(tempind,:)=HOG(imglist{tempind});
        
    end
end

save pos.mat posvector;
% fprintf('pos.mat has been generated\n');
